<x-app-layout>
    <x-erp.page title="Supplier Ledger" subtitle="Track payable balances and settlement history.">
        <x-slot name="actions">
        ...
        <x-erp.section>
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
                ...
                <div class="lg:col-span-3 flex items-end">
                    <x-erp.action-button variant="muted" class="w-full justify-center">Generate Ledger</x-erp.action-button>
                </div>
            </div>
        </x-erp.section>
        ...
        <x-erp.section>
            ...
            <div class="mt-6 overflow-x-auto">
                <table class="min-w-full text-sm text-white/80">
                    ...
                    <tbody>
                        <tr>
                            <td class="py-4 text-white/50" colspan="5">No ledger transactions available.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
