...
<div class="space-y-6">
    ...
    <div>
        ...
        <p class="text-sm text-slate-400 mt-1">Welcome, {{ auth()->user()->name }}! Manage your tax filings and transactions.</p>
    </div>
    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                {{-- PAYE Module --}}
                <a href="{{ route('modules.index', ['module' => 'payroll']) }}" 
