<x-app-layout>
    <x-erp.page title="Profit & Loss" subtitle="Summarize income and expenses by period.">
        <x-slot name="actions">
                ...
                <table class="min-w-full text-sm text-white/80">
                    ...
                    <tbody>
                        <tr class="border-b border-white/5">
                            <td class="py-4">Sales Revenue</td>
                            <td class="py-4 text-right">ZIG 0.00</td>
                        </tr>
                        <tr>
                            <td class="py-4 text-white/50" colspan="2">No data available for the selected period.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
