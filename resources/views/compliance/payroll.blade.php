<x-app-layout>
    <x-erp.page title="Payroll Statutory Checks" subtitle="Validate PAYE, NSSA, ZIMDEF, and AIDS levy compliance.">
        <x-slot name="actions">
        ...
        <x-erp.section>
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
                <div class="lg:col-span-4">
                    <label class="text-xs text-white/70">Payroll period</label>
        ...
        <x-erp.section>
            <div class="mt-1 overflow-x-auto">
                <table class="min-w-full text-sm text-white/80">
                    ...
                    <tbody>
                        <tr>
                            <td class="py-4 text-white/50" colspan="4">No payroll compliance findings.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
