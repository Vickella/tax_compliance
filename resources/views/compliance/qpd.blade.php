<x-app-layout>
    <x-erp.page title="QPD Compliance Checks" subtitle="Monitor provisional tax submissions and due dates.">
        <x-slot name="actions">
        ...
        <x-erp.section>
            <div class="mt-1 overflow-x-auto">
                <table class="min-w-full text-sm text-white/80">
                    ...
                    <tbody>
                        <tr>
                            <td class="py-4 text-white/50" colspan="4">No QPD compliance findings.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
