...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::get('/sales/invoices', [App\Http\Controllers\SalesInvoiceController::class, 'index'])->name('sales.invoices.index');
    Route::get('/sales/invoices/create', [App\Http\Controllers\SalesInvoiceController::class, 'create'])->name('sales.invoices.create');
    ...
    Route::get('/crm/customers', [App\Http\Controllers\CustomerController::class, 'index'])->name('crm.customers.index');
