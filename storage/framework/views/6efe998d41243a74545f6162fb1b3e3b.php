<?php $__env->startSection('page_title','Accounting'); ?>
...
<div class="h-full flex flex-col gap-6">
    ...
    <div class="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <a href="<?php echo e(route('modules.accounting.payments.create')); ?>"
    ...
    <div class="rounded-2xl ring-1 ring-white/10 bg-black/10 overflow-hidden">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 p-5">
            <a href="<?php echo e(route('modules.accounting.chart.index')); ?>"
            ...
            <a href="<?php echo e(route('modules.accounting.payments.index')); ?>"
               class="group rounded-2xl ring-1 ring-white/10 bg-white/5 hover:bg-white/10 transition p-5">
                <div class="flex items-start justify-between gap-4">
                    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3 p-5">
            ...
            <div class="rounded-2xl ring-1 ring-white/10 bg-white/5 hover:bg-white/10 transition p-5">
                ...
                <div class="mt-4 flex items-center gap-2">
                    <a href="<?php echo e(route('modules.accounting.reports.trial-balance')); ?>"
                    ...
                    <a href="<?php echo e(route('modules.accounting.reports.trial-balance.csv')); ?>"
            ...
            <div class="rounded-2xl ring-1 ring-white/10 bg-white/5 hover:bg-white/10 transition p-5">
                ...
                <div class="mt-4 flex items-center gap-2">
                    <a href="<?php echo e(route('modules.accounting.reports.general-ledger')); ?>"
                       class="inline-flex items-center justify-center rounded-xl px-3 py-2 text-xs bg-white/10 hover:bg-white/15 ring-1 ring-white/10 transition">
                        View
                    </a>
                    <a href="<?php echo e(route('modules.accounting.reports.general-ledger.csv')); ?>"
                       class="inline-flex items-center justify-center rounded-xl px-3 py-2 text-xs bg-black/20 hover:bg-black/30 ring-1 ring-white/10 transition">
                        CSV
                    </a>
                </div>
            ...
            <div class="rounded-2xl ring-1 ring-white/10 bg-white/5 hover:bg-white/10 transition p-5">
                ...
                <div class="mt-4 flex items-center gap-2">
                    <a href="<?php echo e(route('modules.accounting.reports.profit-loss')); ?>"
                       class="inline-flex items-center justify-center rounded-xl px-3 py-2 text-xs bg-white/10 hover:bg-white/15 ring-1 ring-white/10 transition">
                        View
                    </a>
                    <a href="<?php echo e(route('modules.accounting.reports.profit-loss.csv')); ?>"
                       class="inline-flex items-center justify-center rounded-xl px-3 py-2 text-xs bg-black/20 hover:bg-black/30 ring-1 ring-white/10 transition">
                        CSV
                    </a>
                </div>
            ...
            <div class="rounded-2xl ring-1 ring-white/10 bg-white/5 hover:bg-white/10 transition p-5">
                ...
                <div class="mt-4 flex items-center gap-2">
                    <a href="<?php echo e(route('modules.accounting.reports.balance-sheet')); ?>"
                       class="inline-flex items-center justify-center rounded-xl px-3 py-2 text-xs bg-white/10 hover:bg-white/15 ring-1 ring-white/10 transition">
                        View
                    </a>
                    <a href="<?php echo e(route('modules.accounting.reports.balance-sheet.csv')); ?>"
                       class="inline-flex items-center justify-center rounded-xl px-3 py-2 text-xs bg-black/20 hover:bg-black/30 ring-1 ring-white/10 transition">
                        CSV
                    </a>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\Instacare\tax_compliance\resources\views/modules/accounting/index.blade.php ENDPATH**/ ?>