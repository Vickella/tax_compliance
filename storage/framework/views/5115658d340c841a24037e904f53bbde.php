...
<?php $__env->startSection('page_title', 'Forecast Profiles'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-7xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-xl font-semibold text-white">Forecast Profiles - <?php echo e($year); ?></h2>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-white/10">
                    ...
                    <tr>
                        <td class="px-4 py-3 font-mono"><?php echo e($profile->account->code ?? 'N/A'); ?></td>
                        <td class="px-4 py-3"><?php echo e($profile->account->name ?? 'Company Level'); ?></td>
                        <td class="px-4 py-3"><?php echo e($profile->account->type ?? 'N/A'); ?></td>
                        <td class="px-4 py-3">
                            <span class="px-2 py-1 rounded-full text-xs 
                                <?php if($profile->forecast_method == 'linear'): ?> bg-blue-600/20 text-blue-300
                                <?php elseif($profile->forecast_method == 'fixed'): ?> bg-emerald-600/20 text-emerald-300
                                <?php else: ?> bg-amber-600/20 text-amber-300
                                <?php endif; ?>">
                                <?php echo e(ucfirst($profile->forecast_method)); ?>

                            </span>
                        </td>
                        <td class="px-4 py-3 text-right">$<?php echo e(number_format($profile->fixed_amount ?? 0, 2)); ?></td>
                        <td class="px-4 py-3 text-right"><?php echo e($profile->growth_rate ?? 0); ?>%</td>
                        <td class="px-4 py-3 text-center">
                            <button onclick="editProfile(<?php echo e($profile->id); ?>)" 
    ...
    <div id="editModal" class="fixed inset-0 bg-black/80 hidden items-center justify-center z-50">
        <div class="bg-slate-900 rounded-xl ring-1 ring-white/10 p-6 max-w-md w-full">
            ...
            <form method="POST" action="<?php echo e(route('modules.tax.qpd.forecast.profiles.store')); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="profile_id" id="profile_id">
                <input type="hidden" name="tax_year" value="<?php echo e($year); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\Victor\tax_compliance\resources\views/modules/tax/qpd/forecast_profiles.blade.php ENDPATH**/ ?>