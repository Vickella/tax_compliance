        ...
        <aside class="w-full lg:w-64 lg:min-h-screen lg:fixed lg:left-0 lg:top-0 border-b lg:border-b-0 lg:border-r border-white/10 bg-black/15 backdrop-blur-sm">
            <div class="h-16 flex items-center gap-3 px-4 border-b border-white/10">
                <img
                    ...
                    alt="<?php echo e(config('app.name', 'ZimTax Compliance')); ?>"
                ...
                <div class="leading-tight">
                    <div class="font-semibold text-sm"><?php echo e(config('app.name', 'ZimTax Compliance')); ?></div>
            ...
            <nav class="px-2 py-3 overflow-y-auto max-h-[calc(100vh-4rem)]">
                <a href="<?php echo e(route('dashboard')); ?>"
                   class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm hover:bg-white/5 transition-colors <?php echo e(request()->routeIs('dashboard') ? 'bg-white/10 ring-1 ring-white/10' : ''); ?>">
                ...
                <div class="mt-2 space-y-1">
                    <?php $__currentLoopData = ($modules ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <a href="<?php echo e(route('modules.index', ['module' => $m['key']])); ?>

                           class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm transition-colors
                                  <?php echo e($active ? 'bg-white/10 ring-1 ring-white/10' : 'hover:bg-white/5'); ?>">
                            <span class="w-6 text-center"><?php echo e($m['icon']); ?></span>
                            <span class="truncate"><?php echo e($m['name']); ?></span>
                        </a>
        ...
        <div class="flex-1 flex flex-col min-h-screen lg:pl-64">
            ...
            <header class="h-16 flex items-center justify-between px-5 border-b border-white/10 bg-black/10 backdrop-blur sticky top-0 z-10">
                <div class="flex items-center gap-3">
                    ...
                    <div class="text-sm font-semibold"><?php echo $__env->yieldContent('page_title', 'Home'); ?></div>
                </div>
            ...
            <footer class="py-3 px-5 text-xs text-slate-400 border-t border-white/5">
                &copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'ZimTax Compliance')); ?>. All rights reserved.
            </footer>
        </div>
    </div>
...
</html><?php /**PATH C:\Users\USER\Desktop\Victor\tax_compliance\resources\views/layouts/erp.blade.php ENDPATH**/ ?>