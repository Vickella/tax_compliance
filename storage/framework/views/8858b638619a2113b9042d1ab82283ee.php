    ...
    <div class="min-h-screen flex flex-col">
            ...
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="font-semibold text-lg"><?php echo e(config('app.name', 'ZimTax')); ?></div>
                    </div>
        ...
        <main class="flex-1 overflow-y-auto">
            <div class="px-4 sm:px-6 lg:px-8 py-6">
                ...
                <div class="mb-6">
                    <h1 class="text-2xl font-semibold"><?php echo $__env->yieldContent('page_title'); ?></h1>
                </div>
                <?php endif; ?>
        ...
        <footer class="bg-black/20 border-t border-white/10 py-3 px-4 sm:px-6 lg:px-8 text-xs text-slate-400">
            <div class="flex justify-between">
                <span>&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'ZimTax')); ?></span>
                <span>v1.0.0</span>
            </div>
        </footer>
    </div>
...
</html><?php /**PATH C:\Users\USER\Desktop\Victor\tax_compliance\resources\views/layouts/app.blade.php ENDPATH**/ ?>