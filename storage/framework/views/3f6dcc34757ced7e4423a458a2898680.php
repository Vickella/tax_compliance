...
<?php $__env->startSection('page_title', 'Tax Settings'); ?>
...
<div class="max-w-4xl mx-auto">
    ...
    <form method="POST" action="<?php echo e(route('modules.tax.settings.update')); ?>">
        <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="vat_rate" step="0.01" min="0" max="100" 
                           value="<?php echo e($settings->vat_rate ?? 15); ?>"
                ...
                <div>
                    ...
                    <input type="number" name="vat_threshold" step="0.01" min="0" 
                           value="<?php echo e($settings->vat_rules['threshold'] ?? 240000); ?>"
                           class="w-full px-3 py-2 rounded-lg bg-black/30 text-white border border-white/10 focus:border-indigo-500 outline-none">
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="number" name="income_tax_rate" step="0.01" min="0" max="100" 
                           value="<?php echo e($settings->income_tax_rate ?? 25.75); ?>"
                           class="w-full px-3 py-2 rounded-lg bg-black/30 text-white border border-white/10 focus:border-indigo-500 outline-none">
                </div>
                <div>
                    ...
                    <input type="number" name="aids_levy_rate" step="0.01" min="0" max="100" 
                           value="<?php echo e($settings->income_tax_rules['aids_levy_rate'] ?? 3); ?>"
                           class="w-full px-3 py-2 rounded-lg bg-black/30 text-white border border-white/10 focus:border-indigo-500 outline-none">
                </div>
                <div>
                    <label class="block text-xs text-slate-400 mb-1">SME Threshold</label>
                    <input type="number" name="sme_threshold" step="0.01" min="0" 
                           value="<?php echo e($settings->income_tax_rules['sme_threshold'] ?? 240000); ?>"
                           class="w-full px-3 py-2 rounded-lg bg-black/30 text-white border border-white/10 focus:border-indigo-500 outline-none">
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                    ...
                    <input type="number" name="qpd_q1_percent" step="0.01" min="0" max="100" 
                           value="<?php echo e($settings->qpd_q1_percent ?? 10); ?>"
                           class="w-full px-3 py-2 rounded-lg bg-black/30 text-white border border-white/10 focus:border-indigo-500 outline-none">
                </div>
                <div>
                    ...
                    <input type="number" name="qpd_q2_percent" step="0.01" min="0" max="100" 
                           value="<?php echo e($settings->qpd_q2_percent ?? 25); ?>"
                           class="w-full px-3 py-2 rounded-lg bg-black/30 text-white border border-white/10 focus:border-indigo-500 outline-none">
                </div>
                <div>
                    ...
                    <input type="number" name="qpd_q3_percent" step="0.01" min="0" max="100" 
                           value="<?php echo e($settings->qpd_q3_percent ?? 30); ?>"
                           class="w-full px-3 py-2 rounded-lg bg-black/30 text-white border border-white/10 focus:border-indigo-500 outline-none">
                </div>
                <div>
                    ...
                    <input type="number" name="qpd_q4_percent" step="0.01" min="0" max="100" 
                           value="<?php echo e($settings->qpd_q4_percent ?? 35); ?>"
                           class="w-full px-3 py-2 rounded-lg bg-black/30 text-white border border-white/10 focus:border-indigo-500 outline-none">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="number" name="late_submission_penalty" step="0.01" min="0" 
                           value="<?php echo e($settings->penalty_rules['late_submission']['amount'] ?? 1000); ?>"
                           class="w-full px-3 py-2 rounded-lg bg-black/30 text-white border border-white/10 focus:border-indigo-500 outline-none">
                </div>
                <div>
                    ...
                    <input type="number" name="late_payment_rate" step="0.01" min="0" 
                           value="<?php echo e($settings->penalty_rules['late_payment']['rate'] ?? 5); ?>"
                           class="w-full px-3 py-2 rounded-lg bg-black/30 text-white border border-white/10 focus:border-indigo-500 outline-none">
                </div>
                <div>
                    ...
                    <input type="number" name="max_penalty_months" min="1" max="60" 
                           value="<?php echo e($settings->penalty_rules['late_payment']['max_months'] ?? 12); ?>"
                           class="w-full px-3 py-2 rounded-lg bg-black/30 text-white border border-white/10 focus:border-indigo-500 outline-none">
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-end gap-3 mt-6 pt-4 border-t border-white/10">
            <a href="<?php echo e(route('modules.tax.index')); ?>" 
...
<?php echo $__env->make('layouts.erp', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\Victor\tax_compliance\resources\views/modules/tax/settings/edit.blade.php ENDPATH**/ ?>