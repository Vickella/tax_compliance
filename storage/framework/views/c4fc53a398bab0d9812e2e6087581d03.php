    ...
    <div class="min-h-screen flex items-center justify-center px-6">
        <div class="w-full max-w-lg text-center">
            <div class="flex justify-center">
                <img src="<?php echo e(asset('assets/images/logo.png')); ?>" class="h-20 w-20 object-contain" alt="ZimTax Compliance">
            </div>
            ...
            <div class="mt-5">
                <a href="<?php echo e(route('password.request')); ?>" class="text-sm underline text-white/80 hover:text-white">
                    Forgot password?
                </a>
            </div>
        </div>
...
<?php /**PATH C:\Users\USER\Desktop\Instacare\tax_compliance\resources\views/welcome.blade.php ENDPATH**/ ?>